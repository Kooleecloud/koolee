 ...
 * so the mark always renders; the tagline needs a real font, fetched from the
 * Fontsource CDN and dropped gracefully if unavailable.
 */

export const alt =
  "Koolee — doorstep luggage pickup, delivered to your airline's bag drop.";
export const size = { width: 1200, height: 630 };
export const contentType = "image/png";

const SORA_URL =
  "https://cdn.jsdelivr.net/fontsource/fonts/sora@latest/latin-600-normal.ttf";
...
export default async function OpenGraphImage() {
  ...
  return new ImageResponse(
    ...
    ),
    {
      ...size,
      fonts: sora
        ? [{ name: "Sora", data: sora, style: "normal" as const, weight: 600 as const }]
        : undefined,
    },
  );
}
