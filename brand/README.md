...
The Koolee brand mark is the **Tag-K** — a tamper-evident luggage tag drawn as
the K of "koolee". Selected 2026-08-02 from a field of four candidates;
`logo-proposals-r2.pdf` is the review deck that documents the decision.

- **Usage rules, color, clear-space, minimum sizes:** see [BRAND.md](BRAND.md)
