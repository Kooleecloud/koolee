...
export interface ButtonProps
  ...
  asChild?: boolean;
  /**
   * Pending state: disables the button, announces busy, and shows a spinner
   * next to the (unchanged) label. Use for every async submit so the user
   * always sees that something is happening. Ignored with `asChild` — links
