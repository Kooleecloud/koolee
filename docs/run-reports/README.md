...
| [RUN-REPORT-13.md](RUN-REPORT-13.md)                         | Slice F4 — the repo's first CI pipeline, the agreement renderer's three missing branches, agreement absence, funnel and cancellation fixes, `reserved_spaces`, `custody_events` unpublished, on-behalf shifts |
| [RUN-REPORT-14.md](RUN-REPORT-14.md)                         | Slice F5 — cancellation lifecycle, the driver map, funnel draft recovery, admin UX                                                                                                                            |
| [RUN-REPORT-15.md](RUN-REPORT-15.md)                         | Map-first trip page, the agent schedule's cancelled stops, driver-position robustness (`driver_position_pings`), and TD's review pass                                                                         |
